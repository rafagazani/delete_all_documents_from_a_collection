...
# appwrite functions createDeployment --functionId=delete_all_documents_from_a_collection --activate=true --entrypoint="delete_all_documents_from_a_collection.py" --code="."
